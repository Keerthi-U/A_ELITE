    ...
    <div id="toggle5">
        <div class="row">
           <div class="h_admitted col-lg-4">
              ...
              <input id="h_admitted" type="text" class="form-control input-sm" name="hospital_name" required>
           </div>  
          <div class="t_o_disease col-lg-4">
          ...
          <div class="n_o_disease col-lg-4">
              ...
              <input id="n_o_disease" type="text" class="form-control input-sm" name="disease_name" required>
          </div>  
          <div class="t_o_disease col-lg-4">
              <label for="t_o_disease">Severity Of Disease</label>
              <select class="custom-select form-control" id="t_o_disease" name="severity_disease" required>
           ...
           <div class="form-group col-lg-4">
               ...
               <div class="d-flex">
                  <input type="text" name="hospital_report" id="file-name3" class=" choose-txt form-control"required >
           ...
           <div class="form-group col-lg-4">
                  ...
                  <div class="d-flex">
                 <input type="text" name="previous_medical_report" id="file-name4" class=" choose-txt form-control" required>
          ...
          <div class="account_details" id="medical_bank">
              <div class="row">
                  <div class="a_number col-lg-4">
                      <label for="a_number">Account Number</label>
                      <input id="a_number" type="text" class="form-control" name="account_no" required>
                  </div> 
             
                  <div class="n_o_bank col-lg-4">
                      <label for="n_o_bank">Name Of Bank</label>
                      <input id="n_o_bank" type="text" class="form-control" name="bank_name" required>
                  </div>  
                  <div class="ifsc_code col-lg-4">
                      <label for="ifsc_code">IFSC Code</label>
              ...
              <div class="row">
                  <div class="aa_number col-lg-4">
                      <label for="aa_number">Aadhar Number</label>
                      <input id="aa_number" type="text" class="form-control" name="aadhar_number" required>
                  </div>  
                  <div class="form-group col-lg-4">
                      <label for="exampleFormControlFile1">Attachement</label>
                      <div class="d-flex">
                          <input type="text" name="bank_attachment" id="file-name2" class="choose-txt form-control"required >
